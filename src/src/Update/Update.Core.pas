...
begin
  ...
  try
    ...
    304: {nothing} ;
    200: begin
         if DownloadPackage.EndsWith('.zip', True) then
           Require(Response.HeaderValue['Content-Type'] = 'application/zip', 'wrong content type')
         else
           Require(Response.HeaderValue['Content-Type'] = 'application/octet-stream', 'wrong content type');
  ...
  begin
    ...
    try
      ...
      begin
        ...
        CheckInstallPackage(DownloadPackage);
