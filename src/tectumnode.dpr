...
uses
  ...
  Desktop in 'src\UI\Desktop.pas',
  Desktop.Controls in 'src\UI\Desktop.Controls.pas',
  Form.Main in 'src\UI\Forms\Form.Main.pas' {MainForm},
  Styles in 'src\UI\Forms\Styles.pas' {StylesForm},
  Frame.Explorer in 'src\UI\Forms\Frame.Explorer.pas' {ExplorerTransactionFrame: TFrame},
  Frame.History in 'src\UI\Forms\Frame.History.pas' {HistoryTransactionFrame: TFrame},
  Frame.Reward in 'src\UI\Forms\Frame.Reward.pas' {RewardFrame: TFrame},
  Frame.Transaction in 'src\UI\Forms\Frame.Transaction.pas' {TransactionFrame: TFrame},
  Frame.StakingTransaction in 'src\UI\Forms\Frame.StakingTransaction.pas' {StakingTransactionFrame: TFrame},
  Frame.Navigation in 'src\UI\Forms\Frame.Navigation.pas' {NavigationFrame: TFrame},
  Frame.Arc in 'src\UI\Forms\Frame.Arc.pas' {ArcFrame: TFrame},
