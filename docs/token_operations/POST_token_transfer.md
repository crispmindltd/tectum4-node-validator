### Purpose
Transfer tokens between two cryptocurrency addresses.
...
### Workflow
1. The user sends a request with the sender's cryptocurrency address, recipient's cryptocurrency address and the amount of tokens to transfer.
